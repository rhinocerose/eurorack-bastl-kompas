...
void setup() {
  ...
  // set pins PB7, PB6, PB3 (led0), PB2 (led1), PB1 (out2) as outputs,
  // PB5, PB4, PB0 as input
  DDRB = B11001110;
  /* PORTB|B00000001; */
  ...
  // set PD7 as input
  DDRD= DDRD & B01111111;
  // set pins PD6, PD5, PD4, PD3, PD2 as outputs
  // leaves PD1 and PD0 as default (ftdi)
  DDRD = DDRD | B01111100;
  /* PORTD|B00000000; */
  // PD7 High
  /* PIND|=B10000000; */
  ...
  switch(trigPreset) {
      case 0:
        PORTD=PORTD&B11010111; // set Out{0,1} low
        PORTB=PORTB&B11111101; // set Out2 low
        PIND|=B00001000; // set Out0 high
        break;
      case 1:
        PORTD=PORTD&B11010111; // set Out{0,1} low
        PORTB=PORTB&B11111101; // set Out2 low
        PIND|=B00100000; // set Out1 high
        break;
      case 2:
        PORTD=PORTD&B11010111; // set Out{0,1} low
        PINB|=B00000010; // set Out2 high
        break;
  }
  //delay(100);
...
//for each incoming clock detected:
  if(clockState) {
    ...
    + "\t" + String(pot0) + "\t" + String(pot1) + "\t" + String(pot2));
